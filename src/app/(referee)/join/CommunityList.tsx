...
export interface CommunityWithStatus extends CommunityRow {
  memberStatus: CommunityMemberRow['status'] | null
}

interface Props {
  initialCommunities: CommunityWithStatus[]
}
...
export default function CommunityList({ initialCommunities }: Props) {
