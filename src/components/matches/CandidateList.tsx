...
export function CandidateList({
  ...
  if (candidates.length === 0) {
    return (
      <div className="rounded-lg border border-dashed border-gray-300 py-12 text-center">
        <p className="text-sm font-medium text-gray-500">条件に合う審判候補が見つかりませんでした</p>
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-gray-500">{candidates.length}名の候補が見つかりました</p>
          ...
          <li key={candidate.id} className="px-4 py-4">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex-shrink-0 text-right">
                <div className="text-sm font-medium text-gray-900">{candidate.total_assignments}回</div>
                <div className="text-xs text-gray-400">担当実績</div>
